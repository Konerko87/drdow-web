  ...
  return (
    <section className="py-28 bg-[#030712] text-white overflow-hidden relative" aria-label="AI 工作流程">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(217,119,6,0.025)_1px,transparent_1px),linear-gradient(90deg,rgba(217,119,6,0.025)_1px,transparent_1px)] bg-[size:48px_48px]" />
      </div>
