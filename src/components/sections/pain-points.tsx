...
export function PainPoints() {
  return (
    <section className="relative py-28 bg-white overflow-hidden" aria-label="痛點分析">
      <DotPattern className="fill-[#6b21a8]/[0.06] [mask-image:radial-gradient(ellipse_at_center,white,transparent_70%)]" />
            ...
            <FadeIn key={i} delay={i * 80}>
              <div className="group relative bg-[#faf5ff] rounded-2xl p-7 border border-[#6b21a8]/[0.06] hover:border-[#6b21a8]/20 transition-all duration-300 h-full">
                ...
                <div className="relative">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#6b21a8]/15 to-[#dc2626]/15 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-300">
                    <DuotoneIcon name={point.icon as IconName} size={28} className="text-[#6b21a8]" />
                  </div>
